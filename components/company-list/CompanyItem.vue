<template>
  <div class="company-item-container">
    <v-col v-for="n in 10" class="py-10 company-item" v-if="!$vuetify.breakpoint.xs">
      <v-row>
        <v-col cols="9" class="d-flex justify-start align-center ">
          ...
          <v-col cols="11" class="pa-0 text-h6 font-weight-bold primary--text company-name">
            <a href="">Shenzhen Yixin New Energy Technology Co., Ltd.</a>
          </v-col>
        </v-col>
    ...
    <!--    Mobile-->
    <v-col v-for="n in 10" class="py-5 company-item" v-if="$vuetify.breakpoint.xs">
      <v-row>
